...
// ("any check failing = reject") on any such failure; callers map this to the API's
...
// to defend against replay / cross-session ("cross-talk") injection.
...
// the receiver rejects rather than guessing a downgrade ("unrecognized = reject").
